...
@ 13,15 say "Saldo: R$" + AllTrim(transform((nOrcamento-nResultadoFinal),"@E 9,999.99")) Color cCor
@ 14,15 say "Resultado Final: R$" + AllTrim(transform(nResultadoFinal, "@E 9,999.99")) Color cCor